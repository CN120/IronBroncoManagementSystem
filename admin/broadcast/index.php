...
<body>
	...
	<div class="page_contents">
		<h1>Message Broadcast</h1>
          ...
          <p>Your message will be sent to all users.</p>
          <form action="./mailer.php" method="post">
               <input type="hidden" name="sender" value="<?= "SCU Iron Bronco <$email>" ?>">
               <input type="text" name="subject" placeholder="Subject" value="">
               <textarea rows="9" name="message" id="message" cols="30" placeholder="Type your email here..."></textarea>
